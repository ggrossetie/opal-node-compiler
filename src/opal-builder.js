  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$[]=', TMP_2 = function($a_rest) {
        ...
        TMP_2.$$p = null;
        value = args.$pop();
        if ((($b = value['$respond_to?']("to_ary")) !== nil && (!$b.$$is_boolean || $b == true))) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$normalize_element', TMP_1 = function ːnormalize_element(extension) {
        ...
        if ((($a = extension['$[]'](/^\./)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return extension
          } else {
          return "." + (extension)
        };
...
if (path == null) path = nil;
      ...
      Opal.defn(self, '$find', TMP_6 = function ːfind($a_rest) {try {
        ...
        if ((block !== nil)) {
          ...
          base_path = $scope.get('Pathname').$new(((($b = options['$[]']("base_path")) !== false && $b !== nil) ? $b : self.root));
...
if (logical_path == null) logical_path = nil;
          logical_path = $scope.get('Pathname').$new(logical_path.$sub(/^\//, ""));
            if ((($a = self['$relative?'](logical_path)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (path == null) path = nil;
      ...
      Opal.defn(self, '$entries', TMP_10 = function ːentries(path) {
        ...
        return ($a = path.$to_s(), $b = self.entries, ((($c = $b['$[]']($a)) !== false && $c !== nil) ? $c : $b['$[]=']($a, (function() {pathname = $scope.get('Pathname').$new(path);
        if ((($d = pathname['$directory?']()) !== nil && (!$d.$$is_boolean || $d == true))) {
...
if (entry == null) entry = nil;
      ...
      Opal.defn(self, '$stat', TMP_11 = function ːstat(path) {
        ...
        key = path.$to_s();
        if ((($a = self.stats['$key?'](key)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.stats['$[]'](key)
        } else if ((($a = $scope.get('File')['$exist?'](path)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$extract_options!', TMP_12 = function(arguments$) {
        ...
        if ((($a = arguments$.$last()['$is_a?']($scope.get('Hash'))) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (base_path == null) base_path = nil;
      ...
      Opal.defn(self, '$find_in_base_path', TMP_16 = function ːfind_in_base_path(logical_path, base_path) {
        ...
        if ((($a = self['$paths_contain?'](dirname)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (path == null) path = nil;
        pathname = dirname.$join(path);
          ...
          if ((($d = (($e = stat !== false && stat !== nil) ? stat['$file?']() : stat)) !== nil && (!$d.$$is_boolean || $d == true))) {
...
if (path == null) path = nil;
      ...
      Opal.defn(self, '$pattern_for', TMP_22 = function ːpattern_for(basename) {
        ...
        return ($a = basename, $b = self.patterns, ((($c = $b['$[]']($a)) !== false && $c !== nil) ? $c : $b['$[]=']($a, self.$build_pattern_for(basename))));
      }, TMP_22.$$arity = 1);
      ...
      Opal.defn(self, '$build_pattern_for', TMP_25 = function ːbuild_pattern_for(basename) {
        ...
        if ((($a = aliases['$any?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (sum == null) sum = nil;if (ext == null) ext = nil;
          if ((($e = i = self.$extensions().$index(ext)) !== nil && (!$e.$$is_boolean || $e == true))) {
              return $rb_plus($rb_plus(sum, i), 1)
            } else if ((($e = i = aliases.$index(ext)) !== nil && (!$e.$$is_boolean || $e == true))) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$normalize_element', TMP_2 = function ːnormalize_element(path) {
        ...
        if ((($a = path['$relative?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (h == null) h = nil;if (k == null) k = nil;
      ...
      Opal.defn(self, '$entries', TMP_15 = function ːentries(path) {
        ...
        if ((($a = pathname['$directory?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$find', TMP_2 = function ːfind(path) {
        ...
        if ((($a = ($b = pathname['$absolute?'](), $b !== false && $b !== nil ?pathname['$exist?']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return path};
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$read', TMP_3 = function ːread(path) {
        ...
        if ((($a = full_path['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil};
...
if (f == null) f = nil;
      ...
      Opal.defn(self, '$expand', TMP_4 = function ːexpand(path) {
        ...
        if ((($a = ((($b = $scope.get('Pathname').$new(path)['$absolute?']()) !== false && $b !== nil) ? $b : path['$=~']((new RegExp("\\A\\.?\\." + (($scope.get('File')).$$scope.get('SEPARATOR'))))))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return path
          } else {
...
if (arg == null) arg = nil;
        ...
        return (Opal.defn(self, '$arity_checks', TMP_33 = function ːarity_checks() {
          ...
          if ((($a = self.arity_checks) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (arg == null) arg = nil;
        ...
        return (Opal.defn(self, '$compile_arity_check', TMP_20 = function ːcompile_arity_check() {
          var $a, $b, $c, $d, self = this, parent_scope = nil, context = nil;

          if ((($a = $rb_gt(self.$arity_checks().$size(), 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
            parent_scope = self.$scope();
            while ((($b = (((($c = ((($d = parent_scope['$top?']()) !== false && $d !== nil) ? $d : parent_scope['$def?']())) !== false && $c !== nil) ? $c : parent_scope['$class_scope?']()))['$!']()) !== nil && (!$b.$$is_boolean || $b == true))) {
            parent_scope = parent_scope.$parent()};
            context = (function() {if ((($a = parent_scope['$top?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              return "'<main>'"
            } else if ((($a = parent_scope['$def?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              return "'" + (parent_scope.$mid()) + "'"
            } else if ((($a = parent_scope['$class?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              return "'<class:" + (parent_scope.$name()) + ">'"
            } else if ((($a = parent_scope['$module?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              return "'<module:" + (parent_scope.$name()) + ">'"
              } else {
              return nil
            }; return nil; })();
            self.$line("if (" + (self.$scope().$identity()) + ".$$is_lambda) {");
...
if (n == null) n = nil;
        vlq = (function() {if ((($c = $rb_lt(n, 0)) !== nil && (!$c.$$is_boolean || $c == true))) {
          ...
          digit = vlq['$&']($scope.get('VLQ_BASE_MASK'));
            ...
            if ((($e = $rb_gt(vlq, 0)) !== nil && (!$e.$$is_boolean || $e == true))) {
...
if (segment == null) segment = nil;
          generated_column = $rb_plus(generated_column, segment['$[]'](0));
            ...
            if ((($e = $rb_ge(segment.$size(), 4)) !== nil && (!$e.$$is_boolean || $e == true))) {
            ...
            if ((($e = segment['$[]'](4)) !== nil && (!$e.$$is_boolean || $e == true))) {
...
if (m == null) m = nil;
        ...
        ary = ($a = ($c = ($range(1, (((($d = by_lines.$keys().$max()) !== false && $d !== nil) ? $d : 1)), false))).$map, $a.$$p = (TMP_23 = function(line){var self = TMP_23.$$s || this, $d, $e, TMP_24, $f, generated_column = nil;
if (line == null) line = nil;
        generated_column = 0;
          return ($d = ($e = (((($f = by_lines['$[]'](line)) !== false && $f !== nil) ? $f : []))).$map, $d.$$p = (TMP_24 = function(mapping){var self = TMP_24.$$s || this, $f, group = nil;
if (mapping == null) mapping = nil;
          group = [];
            ...
            if ((($f = mapping.$name()) !== nil && (!$f.$$is_boolean || $f == true))) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        Opal.defs(self, '$match?', TMP_6 = function(other) {
          ...
          return (($a = other['$is_a?']($scope.get('String')), $a !== false && $a !== nil ?other.$match(self.$match_regexp()) : $a));
        }, TMP_6.$$arity = 1);
        ...
        Opal.defs(self, '$match_regexp', TMP_7 = function ːmatch_regexp() {
          ...
          return ((($a = self.match_regexp) !== false && $a !== nil) ? $a : self.$raise($scope.get('NotImplementedError')));
        }, TMP_7.$$arity = 0);
        ...
        Opal.defn(self, '$source_map', TMP_8 = function ːsource_map() {
          ...
          return ((($a = self.source_map) !== false && $a !== nil) ? $a : self.source_map = (function() {mappings = [];
      ...
      (function($base, $super) {
        ...
        Opal.defn(self, '$compiled', TMP_13 = function ːcompiled() {
          ...
          return ((($a = self.compiled) !== false && $a !== nil) ? $a : self.compiled = (function() {compiler = self.$compiler_for(self.source, $hash2(["file"], {"file": self.filename.$gsub((new RegExp("\\.(rb|js|opal)" + $scope.get('REGEXP_END'))), "")}));
          compiler.$compile();
          return compiler;})());
        }, TMP_13.$$arity = 0);
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      Opal.defn(self, '$require_paths_for_gem', TMP_9 = function ːrequire_paths_for_gem(gem_name, include_dependencies) {
        ...
        if (spec !== false && spec !== nil) {
          } else {
          self.$raise($scope.get('GemNotFound'), gem_name)
        };
        if (include_dependencies !== false && include_dependencies !== nil) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_2 = function ːinitialize(options) {
        ...
        ($a = ($b = (((($c = options) !== false && $c !== nil) ? $c : $hash2([], {})))).$each_pair, $a.$$p = (TMP_1 = function(k, v){var self = TMP_1.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
        return self.$public_send("" + (k) + "=", v)}, TMP_1.$$s = self, TMP_1.$$arity = 2, TMP_1), $a).call($b);
        ((($a = self.stubs) !== false && $a !== nil) ? $a : self.stubs = []);
        ((($a = self.preload) !== false && $a !== nil) ? $a : self.preload = []);
        ((($a = self.processors) !== false && $a !== nil) ? $a : self.processors = $scope.get('DEFAULT_PROCESSORS'));
        ((($a = self.path_reader) !== false && $a !== nil) ? $a : self.path_reader = $scope.get('PathReader').$new());
        ((($a = self.prerequired) !== false && $a !== nil) ? $a : self.prerequired = []);
        ((($a = self.compiler_options) !== false && $a !== nil) ? $a : self.compiler_options = $hash2([], {}));
        ((($a = self.default_processor) !== false && $a !== nil) ? $a : self.default_processor = $scope.get('RubyProcessor'));
      ...
      Opal.defn(self, '$build_str', TMP_6 = function ːbuild_str(source, filename, options) {
        ...
        try {
          if ((($a = self['$stub?'](filename)) !== nil && (!$a.$$is_boolean || $a == true))) {
            } else {
...
if (r == null) r = nil;
      ...
      Opal.defn(self, '$tree_requires', TMP_17 = function ːtree_requires(asset, path) {
        ...
        if ((($a = ((($b = path['$nil?']()) !== false && $b !== nil) ? $b : path['$empty?']())) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (p == null) p = nil;
          ...
          if ((($d = base['$nil?']()) !== nil && (!$d.$$is_boolean || $d == true))) {
            return [];};
...
if (p == null) p = nil;
        ...
        ((($a = processor) !== false && $a !== nil) ? $a : processor = self.$default_processor());
      ...
      Opal.defn(self, '$read', TMP_20 = function ːread(path) {
        ...
        return ((($a = self.$path_reader().$read(path)) !== false && $a !== nil) ? $a : self.$raise($scope.get('MissingRequire'), "can't find file: " + (path.$inspect()) + " in " + (self.$path_reader().$paths().$inspect())));
      }, TMP_20.$$arity = 1);
      ...
      Opal.defn(self, '$process_require', TMP_21 = function ːprocess_require(filename, options) {
        ...
        if ((($a = self.$prerequired()['$include?'](filename)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil};
        if ((($a = self.$already_processed()['$include?'](filename)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil};
        self.$already_processed()['$<<'](filename);
        source = (function() {if ((($a = self['$stub?'](filename)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return ""
          } else {
          return self.$read(filename)
        }; return nil; })();
        if ((($a = source['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (r == null) r = nil;
      ...
      Opal.defn(self, '$already_processed', TMP_24 = function ːalready_processed() {
        ...
        return ((($a = self.already_processed) !== false && $a !== nil) ? $a : self.already_processed = $scope.get('Set').$new());
      }, TMP_24.$$arity = 0);
      ...
      return (Opal.defn(self, '$extensions', TMP_26 = function ːextensions() {
        ...
        return ((($a = self.extensions) !== false && $a !== nil) ? $a : self.extensions = ($b = ($c = $scope.get('DEFAULT_PROCESSORS')).$flat_map, $b.$$p = "extensions".$to_proc(), $b).call($c).$compact());
