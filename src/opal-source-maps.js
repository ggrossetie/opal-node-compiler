...
Opal.modules["opal/source_map/file"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$names', $File_names$5 = function $$names() {
      ...
      return (self.names = ($truthy($a = self.names) ? $a : (self.$absolute_mappings(), $send($send(self.names_map.$to_a(), 'sort_by', [], ($$6 = function(_, index){var self = $$6.$$s == null ? this : $$6.$$s;
    ...
    Opal.def(self, '$relative_mappings', $File_relative_mappings$9 = function $$relative_mappings() {
      ...
      return (self.relative_mappings = ($truthy($a = self.relative_mappings) ? $a : ((reference_segment = [0, 0, 0, 0, 0]), (reference_name_index = 0), $send(self.$absolute_mappings(), 'map', [], ($$10 = function(absolute_mapping){var self = $$10.$$s == null ? this : $$10.$$s, $$11, $writer = nil;
        ...
        $writer[$rb_minus($writer["length"], 1)];;
        return $send(absolute_mapping, 'map', [], ($$11 = function(absolute_segment){var self = $$11.$$s == null ? this : $$11.$$s, $b, segment = nil;
    ...
    Opal.def(self, '$absolute_mappings', $File_absolute_mappings$12 = function $$absolute_mappings() {
      ...
      return (self.absolute_mappings = ($truthy($a = self.absolute_mappings) ? $a : ((mappings = []), $send(self.$fragments_by_line(), 'each', [], ($$13 = function(raw_segments){var self = $$13.$$s == null ? this : $$13.$$s, $$14, generated_column = nil, segments = nil;
        ...
        generated_column = 0;
        segments = [];
        $send(raw_segments, 'each', [], ($$14 = function($mlhs_tmp1){var self = $$14.$$s == null ? this : $$14.$$s, $b, $c, generated_code = nil, fragment = nil;
    ...
    return (Opal.def(self, '$fragments_by_line', $File_fragments_by_line$15 = function $$fragments_by_line() {
      ...
      $send(self.$fragments(), 'flat_map', [], ($$16 = function(fragment){var self = $$16.$$s == null ? this : $$16.$$s, $$17, fragment_code = nil, fragment_lines = nil;
        ...
        return $send(fragment_lines.$each(), 'with_index', [], ($$17 = function(fragment_line, index){var self = $$17.$$s == null ? this : $$17.$$s, $a, raw_segment = nil;
