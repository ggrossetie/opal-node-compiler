Opal.modules["base64"] = function(Opal) {/* Generated by Opal 1.3.1 */
...
Opal.modules["opal/source_map/map"] = function(Opal) {/* Generated by Opal 1.3.1 */
...
Opal.modules["opal/source_map/file"] = function(Opal) {/* Generated by Opal 1.3.1 */
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
...
Opal.modules["opal/source_map/index"] = function(Opal) {/* Generated by Opal 1.3.1 */
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
...
Opal.modules["opal/source_map/vlq"] = function(Opal) {/* Generated by Opal 1.3.1 */
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  function $rb_lt(lhs, rhs) {
...
Opal.modules["opal/source_map"] = function(Opal) {/* Generated by Opal 1.3.1 */
...
Opal.modules["opal-source-maps"] = function(Opal) {/* Generated by Opal 1.3.1 */
