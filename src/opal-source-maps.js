...
Opal.modules["opal/source_map/map"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    return (Opal.def(self, '$to_data_uri_comment', $Map_to_data_uri_comment$5 = function $$to_data_uri_comment() {
      var self = this;

      return "" + "//# sourceMappingURL=data:application/json;base64," + ($$($nesting, 'Base64').$encode64(self.$to_json()).$delete("\n"))
    }, $Map_to_data_uri_comment$5.$$arity = 0), nil) && 'to_data_uri_comment';
...
Opal.modules["opal/source_map/file"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$segment_from_fragment', $File_segment_from_fragment$8 = function $$segment_from_fragment(fragment, generated_column) {
      var self = this, source_index = nil, original_line = nil, original_column = nil, map_name_index = nil, $ret_or_3 = nil, $writer = nil;
      ...
      if ($truthy(fragment.$source_map_name())) {
        ...
        map_name_index = (function() {if ($truthy(($ret_or_3 = self.names_map['$[]'](fragment.$source_map_name().$to_s())))) {
          return $ret_or_3
        } else {
    ...
    Opal.def(self, '$relative_mappings', $File_relative_mappings$9 = function $$relative_mappings() {
      var $$10, self = this, $ret_or_4 = nil, reference_segment = nil, reference_name_index = nil;

      return (self.relative_mappings = (function() {if ($truthy(($ret_or_4 = self.relative_mappings))) {
        return $ret_or_4
      } else {
        ...
        return $send(self.$absolute_mappings(), 'map', [], ($$10 = function(absolute_mapping){var self = $$10.$$s == null ? this : $$10.$$s, $$11, $writer = nil;
          ...
          $writer[$rb_minus($writer["length"], 1)];;
          return $send(absolute_mapping, 'map', [], ($$11 = function(absolute_segment){var self = $$11.$$s == null ? this : $$11.$$s, segment = nil, $ret_or_5 = nil, $ret_or_6 = nil, $ret_or_7 = nil, $ret_or_8 = nil;
            ...
            $writer = [1, $rb_minus(absolute_segment['$[]'](1), (function() {if ($truthy(($ret_or_5 = reference_segment['$[]'](1)))) {
              return $ret_or_5
            } else {
              return 0
            }; return nil; })())];
            ...
            $writer = [2, $rb_minus(absolute_segment['$[]'](2), (function() {if ($truthy(($ret_or_6 = reference_segment['$[]'](2)))) {
              return $ret_or_6
            } else {
              return 0
            }; return nil; })())];
            ...
            $writer = [3, $rb_minus(absolute_segment['$[]'](3), (function() {if ($truthy(($ret_or_7 = reference_segment['$[]'](3)))) {
              return $ret_or_7
            } else {
              return 0
            }; return nil; })())];
            ...
            if ($truthy(absolute_segment['$[]'](4))) {
              ...
              $writer = [4, $rb_minus(absolute_segment['$[]'](4).$to_int(), (function() {if ($truthy(($ret_or_8 = reference_segment['$[]'](4)))) {
                return $ret_or_8
              } else {
    ...
    Opal.def(self, '$absolute_mappings', $File_absolute_mappings$12 = function $$absolute_mappings() {
      var $$13, self = this, $ret_or_9 = nil, mappings = nil;

      return (self.absolute_mappings = (function() {if ($truthy(($ret_or_9 = self.absolute_mappings))) {
        return $ret_or_9
      } else {
        ...
        $send(self.$fragments_by_line(), 'each', [], ($$13 = function(raw_segments){var self = $$13.$$s == null ? this : $$13.$$s, $$14, generated_column = nil, segments = nil;
          ...
          generated_column = 0;
          segments = [];
          $send(raw_segments, 'each', [], ($$14 = function($mlhs_tmp1){var self = $$14.$$s == null ? this : $$14.$$s, $a, $b, generated_code = nil, fragment = nil, $ret_or_10 = nil;
            ...
            if ($truthy((function() {if ($truthy(($ret_or_10 = fragment.$line()))) {
    ...
    return (Opal.def(self, '$fragments_by_line', $File_fragments_by_line$15 = function $$fragments_by_line() {
      ...
      $send(self.$fragments(), 'flat_map', [], ($$16 = function(fragment){var self = $$16.$$s == null ? this : $$16.$$s, $$17, fragment_code = nil, fragment_lines = nil;
        ...
        return $send(fragment_lines.$each(), 'with_index', [], ($$17 = function(fragment_line, index){var self = $$17.$$s == null ? this : $$17.$$s, raw_segment = nil, $ret_or_11 = nil, $ret_or_12 = nil;
          ...
          if ($truthy((function() {if ($truthy(($ret_or_11 = index['$zero?']()))) {
            return fragment_line.$size()['$zero?']()['$!']()
          } else {
            return $ret_or_11
          }; return nil; })())) {
            return raw_mappings.$last()['$<<'](raw_segment)
          } else if ($truthy((function() {if ($truthy(($ret_or_12 = index['$zero?']()))) {
            return fragment_line.$size()['$zero?']()
          } else {
            return $ret_or_12
          }; return nil; })())) {
